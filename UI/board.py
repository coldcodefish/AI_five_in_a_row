...
class ChessBoard(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # role 字典：值为 "player" 或算法名称
        self.role = {BLACK: "player", WHITE: "评分算法"}
        self.move_history = []
        self.winner = None
    ...
    def mousePressEvent(self, event):
        ...
        if not self.game_started or self.game_over:
            return
        if self.role[self.current_player] != "player":
            return
    ...
    def ai_move(self):
        ...
        algorithm = self.role[self.current_player]
